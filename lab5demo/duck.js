...
choice:     determines whether a duck, goose or swan will be drawn based on user input in the select menu

RETURNS:
canvas
****************************************************************** */

function duck(canvas = d3.select.append("svg").attr("width", 500).attr("height", 500), xInput, yInput, orIsVisible = false, choice) {
